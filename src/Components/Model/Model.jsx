    ...
    >
      <div className="model_container">
        <div className="model_header">
          ...
          <div className="status">{Statuslabel(launch.launch_success)}</div>
        </div>
        ...
        <div className="more_details">
          <div className="details1">
            ...
            <div className="details2">{launch.flight_number}</div>
            <hr></hr>
          </div>
          <div className="details1">
            <div className="heading">Mission Name</div>
            <div className="details2">{launch.mission_name}</div>
            <hr></hr>
          </div>
          <div className="details1">
            <div className="heading">Rocket Type</div>
            <div className="details2">{launch.rocket.rocket_type}</div>
            <hr></hr>
          </div>
          <div className="details1">
            <div className="heading">Rocket Name</div>
            <div className="details2">{launch.rocket.rocket_name}</div>
            <hr></hr>
          </div>
          <div className="details1">
          ...
          <div className="details1">
            <div className="heading">Launch Date</div>
            <div className="details2">
          ...
          <div className="details1">
            <div className="heading">Payload type</div>
            <div className="details2">
          ...
          <div className="details1">
            <div className="heading">Launch Site</div>
            <div className="details2">{launch.launch_site.site_name}</div>
          </div>
        </div>
      </div>
    </ReactModal>
